...
function useClassifier(options) {
  ...
  const [method, setMethodInternal] = react.useState(options.method ?? DEFAULT_METHOD);
  const [nClasses, setNClasses] = react.useState(options.nClasses ?? DEFAULT_NB_CLASSES);
  const [paletteName, setPalette] = react.useState(options.palette ?? DEFAULT_PALETTE);
  const [reversed, setReversed] = react.useState(options.reversed ?? false);
  const [isEditingCustomBreaks, setIsEditingCustomBreaks] = react.useState(false);
  const [customBreaks, setCustomBreaks] = react.useState(null);
  const [lastAutoMethod, setLastAutoMethod] = react.useState(
    (options.method ?? DEFAULT_METHOD) === "custom" ? DEFAULT_METHOD : options.method ?? DEFAULT_METHOD
  );
  const autoBreaks = react.useMemo(() => {
  ...
  const classResult = react.useMemo(() => {
  ...
  const histogramDomain = react.useMemo(() => {
  ...
  const startEditCustomBreaks = react.useCallback(() => {
    setCustomBreaks(classResult.breaks.length > 0 ? [...classResult.breaks] : null);
    setIsEditingCustomBreaks(true);
  }, [classResult.breaks]);
  const editBreakValue = react.useCallback(
    (index, value) => {
  ...
  const confirmCustomBreaks = react.useCallback(() => {
    setIsEditingCustomBreaks(false);
  }, []);
  const cancelCustomBreaks = react.useCallback(() => {
    if (method === "custom") {
...
function usePaletteUI(options = {}) {
  ...
  const setConfig = react.useCallback((partial) => {
...
function Dropdown({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref, style: { position: "relative", width: "100%", minWidth: "80px" }, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        disabled,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: value ? getLabel(value) : placeholder || "Select..." }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { marginLeft: "4px" }, children: "\u25BE" })
        ]
      }
    ),
...
var HistogramChart = ({
  ...
  const [measuredWidth, setMeasuredWidth] = react.useState(widthProp ?? 210);
  react.useEffect(() => {
  ...
  const { xScale, yScale, domainMin, domainMax } = react.useMemo(() => {
    if (!bins.length) {
      return {
        xScale: () => 0,
        yScale: () => innerHeight,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ref: containerRef, style: { marginTop: "8px", width: "100%" }, children: /* @__PURE__ */ jsxRuntime.jsx("svg", { width, height, children: /* @__PURE__ */ jsxRuntime.jsxs("g", { transform: `translate(${MARGIN.left},${MARGIN.top})`, children: [
    bins.map((bin, i) => {
...
var MethodSelector = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontFamily: "var(--sb-font-family)" }, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Method" }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: { width: "80%" }, children: /* @__PURE__ */ jsxRuntime.jsx(
            Dropdown,
            {
    ...
    bins && bins.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
      HistogramChart,
      {
        bins,
        legend,
...
var PaletteStrip = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: colors.map((color2, i) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flex: 1, backgroundColor: color2 } }, `${color2}-${i}`))
    }
  );
};
...
var STEP_OPTIONS = d3Array.range(3, 10);
var PaletteSelector = ({
  selectedPalette,
  config,
  onSelectPalette,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontFamily: "var(--sb-font-family)", color: "var(--sb-text-primary, #a0a7b4)" }, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "12px 12px 0 12px" }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: configRowStyle, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Type" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { width: "40%" }, children: /* @__PURE__ */ jsxRuntime.jsx(
          Dropdown,
          {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: configRowStyle, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Steps" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { width: "40%" }, children: /* @__PURE__ */ jsxRuntime.jsx(
          Dropdown,
          {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: configRowStyle, children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Reversed" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { width: "40%" }, children: /* @__PURE__ */ jsxRuntime.jsx(Switch, { checked: reversed, onChange: (val) => onConfigChange({ reversed: val }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { maxHeight: "200px", overflowY: "auto", padding: "0 8px 8px 8px" }, children: [
      ...
      filteredPalettes.length === 0 && /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          style: {
            padding: "12px",
...
var BreaksLegend = ({
  ...
  if (!isEditing) {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "8px 12px 0 12px" }, children: [
      ...
      legend.map((item, index) => /* @__PURE__ */ jsxRuntime.jsxs("div", { style: RowStyle, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...SwatchStyle, backgroundColor: item.color } }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "8px 12px 0 12px" }, children: [
    legend.map((item, index) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { ...RowStyle, gap: "4px" }, children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...SwatchStyle, backgroundColor: item.color } }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ThresholdInput,
          {
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "var(--sb-text-secondary, #6a7485)", padding: "0 2px" }, children: "\u2014" }),
        /* @__PURE__ */ jsxRuntime.jsx(
          ThresholdInput,
          {
            value: item.range[1],
...
var ClassifierPanel = ({
  ...
  const handleSelectPalette = react.useCallback(
    (name) => {
      setPalette(name);
    },
    [setPalette]
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: sectionStyle, children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: labelStyle, children: "Classification" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            MethodSelector,
            {
              method,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: sectionStyle, children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: labelStyle, children: "Color Palette" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            PaletteSelector,
            {
        ...
        legend.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "8px 0" }, children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...labelStyle, padding: "0 12px" }, children: "Legend" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            BreaksLegend,
            {
              legend,
...
exports.BreaksLegend = BreaksLegend;
exports.CLASSIFICATION_METHODS = CLASSIFICATION_METHODS;
exports.ClassifierPanel = ClassifierPanel;
...
exports.PaletteStrip = PaletteStrip;
...
exports.usePaletteUI = usePaletteUI;
