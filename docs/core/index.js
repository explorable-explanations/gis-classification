...
export { ALL_PALETTES, CLASSIFICATION_METHODS, DEFAULT_METHOD, DEFAULT_MISSING_COLOR, DEFAULT_MISSING_TEXT, DEFAULT_NB_CLASSES, DEFAULT_PALETTE, DIVERGING_SCHEMES, METHODS, QUALITATIVE_SCHEMES, SEQUENTIAL_SCHEMES, breaksToLegend, classify, colorToHex, colorizeChoropleth, computeHistogram, formatNumber, getHistogramDomain, getPaletteByName, getPalettesByType, hexToRgb };
